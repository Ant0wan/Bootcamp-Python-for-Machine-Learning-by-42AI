...
class TestVectorClass(unittest.TestCase):
    ...
    def test_dot(self):
        ...
        vec_test= Vector([[1.0]])
        b = Vector([[4.0]])
        self.assertEqual(vec_test.dot(b), [[4.0]])
        vec_test= Vector([1.0])
        b = Vector([[4.0]])
        self.assertEqual(vec_test.dot(b), [[4.0]])
        vec_test= Vector([[1.0]])
        ...
        self.assertEqual(vec_test.dot(b), [[14.0]])
        vec_test= Vector([-0.0, -1.0, -2.0, -3.0])
        b = Vector([[-0.0], [-1.0], [-2.0], [-3.0]])
        self.assertEqual(vec_test.dot(b), [[14.0]])
        vec_test= Vector([[0.0]])
        b = Vector([[0.0]])
        self.assertEqual(vec_test.dot(b), [[0.0]])
        vec_test= Vector([[0.0, 3.0, 5.0], [5.0, 5.0, 2.0]])
        b = Vector([[3.0], [4.0], [3.0]])
        self.assertEqual(vec_test.dot(b), [[27.0], [41.0]])
        b = Vector([[3.0, 1.0],[4.0, 2.0],[3.0, 3.0]])
        self.assertEqual(vec_test.dot(b), [[27.0, 21.0], [41.0, 21.0]])
    ...
    def test_T(self):
        ...
        vec_test= Vector([0.0, 1.0, 2.0, 3.0])
        b = Vector([[0.0], [1.0], [2.0], [3.0]])
        self.assertEqual(vec_test.T().values, b.values)
        vec_test= Vector([[0.0, 1.0, 2.0, 3.0]])
        b = Vector([[0.0], [1.0], [2.0], [3.0]])
        self.assertEqual(vec_test.T().values, b.values)
        vec_test= Vector([[0.0, 3.0, 5.0], [5.0, 5.0, 2.0]])
